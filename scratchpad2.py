from typing import Tuple, Optional, Literal, Any, ClassVar
...
PositionMarginType = str | int | GlobalType | Literal["auto"]
SizeType = int | str | GlobalType | Literal["auto"]
MaxSizeType = int | str | GlobalType | Literal["none"]
MinSizeType = int | str | GlobalType | Literal["auto"]
PaddingType = int | str | GlobalType
...
class Style:
    ...
    # Animation properties are not included and there isno current plan to include them
    ...
    direction: Literal["ltr", "rtl", "inherit", "initial"] = field(default="rtl", metadata=gen_metadata(inherited=True))
    ...
    # Transform properties are not included and there isno current plan to include them
    ...
    def __init__(self, **kwargs):
        super().__setattr__("_order", list(kwargs.keys()))
...
start = time.time()
print(s.get_defined_fields())
print("get_defined_fields time",time.time() - start)